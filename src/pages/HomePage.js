                  ...
                  <div id="procedure-content" className="space-y-4 text-sm text-gray-700 mt-4">
                    <div>
                      ...
                      <ol className="list-decimal list-inside space-y-1 ml-2">
                        <li>You can Download the Rights Circular on our website using this link <a href="https://lasaco.apel.com.ng" className="text-green-600 hover:underline" target="_blank" rel="noopener noreferrer">https://lassaco.apel.com.ng</a></li>
